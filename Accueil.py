...
class Window(QWidget):
    def __init__(self):
        ...
        # Image de fond
        self.background = QLabel(self) #affiche l'image de fond
        self.background.setScaledContents(True) #l'image est redimensionnée pour remplir le label
        self.background.lower() #mettre en arriere
    ...
    def _init_buttons(self):
        ...
        self.button.setFixedSize(400, 90) #taille fixe
        font = self.button.font()
        font.setPointSize(30) #taille police
    ...
    def _init_layout(self):
        ...
        top_layout.addStretch() #centrer le bouton principal
    ...
    def _update_background(self):
        ...
        if pixmap.isNull():
            print("Attention image introuvable")  # Alerte si l'image est absente
            return
